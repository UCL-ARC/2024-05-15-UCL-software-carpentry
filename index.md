...
address: "Cruciform Building B1.15A - Public Cluster"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "51.524029"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-0.135114"       # decimal longitude of the workshop venue (use https://www.latlong.net)
...
instructor: ["David Wong", "Ed Lowther", "Milan Malfait", "Kimberly Meechan"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["William Graham", "Stella Prins"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["william.graham@ucl.ac.uk"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://hackmd.io/@willGraham01/SJmU8imW0/edit # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
